...
`https://mapd.kcmo.org/kcgis/rest/services/DataLayers/MapServer/38/query?f=json&where=PLATNAME%20like%20%27CARRIAGE%20HILL%20ESTATES%25%27&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=*&callback=`
